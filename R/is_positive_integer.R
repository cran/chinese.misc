...
#'
#' \itemize{
#'   \item (1) We often check if an object is a vector of positive integer. But \code{is.numeric} cannot #' do this because it also returns \code{TRUE} for a numeric matrix. 
#'   \item (2) Sometimes \code{is.vector} 
